...
#     
#     
#     (really we need to import some audio data, let's do it.)
...
[a_song_data, a_song_labels] = get_fft('../sounds/07wishyouwerehere.wav', 1, 5)
...
net.blobs['data'].reshape(1,        # batch size
                          2,         # 3-channel (BGR) images
                          30, 1470)  # image size is 227x227


net.set_input_arrays(np.array(a_song_data, dtype=np.float32), np.array(a_song_labels, dtype=np.float32))
...
# download an image
my_image_url = "http://www.humanesociety.org/assets/images/270x224/animals/skunks/skunk-1.jpg"  # paste your URL here
# for example:
